/* 
At the time of writing this these are all of data types that exist in the JSON
For now this is to just be used as a reference but I could adapt it to automaticly create var_types.json
*/
